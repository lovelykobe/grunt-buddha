...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('buddha', 'Buddha\'s grace illuminates code as sunshine', function () {
    ...
    commentSymbol = options.commentSymbol,commentFilepathMap = {
      'buddha':'assets/buddha.txt',
      'alpaca':'assets/alpaca.txt'
    },commentFilepath = path.join(__dirname, commentFilepathMap[who]),
    commentContent = grunt.file.read(commentFilepath),lineCommentArr = commentContent.split(grunt.util.normalizelf('\n'));
